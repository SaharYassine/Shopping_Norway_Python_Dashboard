...
def build_line_chart(option):
    ...
    if option == "all":
        ...
        fig = px.bar(group_year,
                     ...
                     title=f"Total Sales Per Year",
                     labels={"index": f"Year", "y": "Total Sales in Krone"}, )
        ...
        fig = px.line(df_filterd_group,
                      ...
                      labels={"index": f"Months of {option}", "value": "Total Sales in Krone"}, )
...
def build_pie_bar(option):
    ...
    bar_horiz_fig = px.bar(shopping_malls,
                     ...
                     labels={"shopping_mall": "Shopping Mall", "value": "Total Sales In Krone"},
                     )
